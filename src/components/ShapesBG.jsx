...
function ShapesBG({ deg }) {
  // console.log({ deg });
  // TO DO move with mouse parallax https://stackoverflow.com/questions/50802681/how-to-pass-props-to-keyframes-in-styled-component-with-react
  ...
  return (
    <Container>
      ...
      <SVG
        ...
        deg={deg}
      >
        <g fill="#70d6ff" fillRule="evenodd">
      ...
      <SVG
        ...
        deg={deg}
      >
        <g fill="#e9ff70" fillRule="evenodd">
